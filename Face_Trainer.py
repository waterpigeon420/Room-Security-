...
for root, dirs, files in os.walk(Face_Images): #go to the face image directory 
    for file in files: #check every directory in it 
            ...
            if pev_person_name != person_name: #Check if the name of person has change
            ...
            #print(Numpy_Image)
            faces = face_cascade.detectMultiScale(Final_Image, minNeighbors=5) #Detect The face in all sample image 
            print (Face_ID,faces)
...
recognizer.write("face-trainner.yml") #Save the matrix as YML file 